...
// 	protoc        v3.19.1
// source: idl/favorite/favorite.proto
...
func (x *DouyinFavoriteActionRequest) Reset() {
	*x = DouyinFavoriteActionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_favorite_favorite_proto_msgTypes[0]
...
func (*DouyinFavoriteActionRequest) Descriptor() ([]byte, []int) {
	return file_idl_favorite_favorite_proto_rawDescGZIP(), []int{0}
}
...
func (x *DouyinFavoriteActionResponse) Reset() {
	*x = DouyinFavoriteActionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_favorite_favorite_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinFavoriteActionResponse) Descriptor() ([]byte, []int) {
	return file_idl_favorite_favorite_proto_rawDescGZIP(), []int{1}
}
...
func (x *DouyinFavoriteListRequest) Reset() {
	*x = DouyinFavoriteListRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_favorite_favorite_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinFavoriteListRequest) Descriptor() ([]byte, []int) {
	return file_idl_favorite_favorite_proto_rawDescGZIP(), []int{2}
}
...
func (x *DouyinFavoriteListResponse) Reset() {
	*x = DouyinFavoriteListResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_favorite_favorite_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinFavoriteListResponse) Descriptor() ([]byte, []int) {
	return file_idl_favorite_favorite_proto_rawDescGZIP(), []int{3}
}
...
func (x *Video) Reset() {
	*x = Video{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_favorite_favorite_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Video) Descriptor() ([]byte, []int) {
	return file_idl_favorite_favorite_proto_rawDescGZIP(), []int{4}
}
...
func (x *User) Reset() {
	*x = User{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_favorite_favorite_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*User) Descriptor() ([]byte, []int) {
	return file_idl_favorite_favorite_proto_rawDescGZIP(), []int{5}
}
...
var File_idl_favorite_favorite_proto protoreflect.FileDescriptor

var file_idl_favorite_favorite_proto_rawDesc = []byte{
	0x0a, 0x1b, 0x69, 0x64, 0x6c, 0x2f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x2f, 0x66,
	0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08, 0x66,
	0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x22, 0x72, 0x0a, 0x1e, 0x64, 0x6f, 0x75, 0x79, 0x69,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x8f, 0x01,
	...
	0xfa, 0x01, 0x0a, 0x05, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x26, 0x0a, 0x06, 0x61, 0x75, 0x74,
	0x68, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x66, 0x61, 0x76, 0x6f,
	0x72, 0x69, 0x74, 0x65, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x06, 0x61, 0x75, 0x74, 0x68, 0x6f,
	...
	0x03, 0x52, 0x0d, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74,
	0x32, 0xd5, 0x01, 0x0a, 0x0b, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x53, 0x72, 0x76,
	0x12, 0x65, 0x0a, 0x0e, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x41, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x12, 0x28, 0x2e, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x2e, 0x64, 0x6f,
	0x75, 0x79, 0x69, 0x6e, 0x5f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x5f, 0x61, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x29, 0x2e, 0x66,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5f, 0x0a, 0x0c, 0x46, 0x61, 0x76, 0x6f, 0x72,
	0x69, 0x74, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x26, 0x2e, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69,
	...
	0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x1b, 0x5a, 0x19, 0x64, 0x6f, 0x75, 0x79,
	0x69, 0x6e, 0x2f, 0x6b, 0x69, 0x74, 0x65, 0x78, 0x5f, 0x67, 0x65, 0x6e, 0x2f, 0x66, 0x61, 0x76,
	0x6f, 0x72, 0x69, 0x74, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_idl_favorite_favorite_proto_rawDescOnce sync.Once
	file_idl_favorite_favorite_proto_rawDescData = file_idl_favorite_favorite_proto_rawDesc
)

func file_idl_favorite_favorite_proto_rawDescGZIP() []byte {
	file_idl_favorite_favorite_proto_rawDescOnce.Do(func() {
		file_idl_favorite_favorite_proto_rawDescData = protoimpl.X.CompressGZIP(file_idl_favorite_favorite_proto_rawDescData)
	})
	return file_idl_favorite_favorite_proto_rawDescData
}

var file_idl_favorite_favorite_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_idl_favorite_favorite_proto_goTypes = []interface{}{
...
var file_idl_favorite_favorite_proto_depIdxs = []int32{
...
func init() { file_idl_favorite_favorite_proto_init() }
func file_idl_favorite_favorite_proto_init() {
	if File_idl_favorite_favorite_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_idl_favorite_favorite_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_favorite_favorite_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_favorite_favorite_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_favorite_favorite_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_favorite_favorite_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Video); i {
			case 0:
				return &v.state
			case 1:
		...
		file_idl_favorite_favorite_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_idl_favorite_favorite_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_idl_favorite_favorite_proto_goTypes,
		DependencyIndexes: file_idl_favorite_favorite_proto_depIdxs,
		MessageInfos:      file_idl_favorite_favorite_proto_msgTypes,
	}.Build()
	File_idl_favorite_favorite_proto = out.File
	file_idl_favorite_favorite_proto_rawDesc = nil
	file_idl_favorite_favorite_proto_goTypes = nil
	file_idl_favorite_favorite_proto_depIdxs = nil
}
