...
func (x *DouyinFeedRequest) Reset() {
	*x = DouyinFeedRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_videoapi_proto_msgTypes[0]
...
func (*DouyinFeedRequest) Descriptor() ([]byte, []int) {
	return file_videoapi_proto_rawDescGZIP(), []int{0}
}
...
func (x *DouyinFeedResponse) Reset() {
	*x = DouyinFeedResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_videoapi_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinFeedResponse) Descriptor() ([]byte, []int) {
	return file_videoapi_proto_rawDescGZIP(), []int{1}
}
...
func (x *DouyinPublishActionRequest) Reset() {
	*x = DouyinPublishActionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_videoapi_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinPublishActionRequest) Descriptor() ([]byte, []int) {
	return file_videoapi_proto_rawDescGZIP(), []int{2}
}
...
func (x *DouyinPublishActionResponse) Reset() {
	*x = DouyinPublishActionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_videoapi_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinPublishActionResponse) Descriptor() ([]byte, []int) {
	return file_videoapi_proto_rawDescGZIP(), []int{3}
}
...
func (x *DouyinPublishListRequest) Reset() {
	*x = DouyinPublishListRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_videoapi_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinPublishListRequest) Descriptor() ([]byte, []int) {
	return file_videoapi_proto_rawDescGZIP(), []int{4}
}
...
type DouyinPublishListResponse struct {
	...
	StatusCode int32    `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty" form:"status_code" query:"status_code"` // 状态码，0-成功，其他值-失败
	StatusMsg  string   `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" json:"status_msg,omitempty" form:"status_msg" query:"status_msg"`       // 返回状态描述
	VideoList  []*Video `protobuf:"bytes,3,rep,name=video_list,json=videoList,proto3" json:"video_list,omitempty" form:"video_list" query:"video_list"`       // 用户发布的视频列表
}

func (x *DouyinPublishListResponse) Reset() {
	*x = DouyinPublishListResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_videoapi_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinPublishListResponse) Descriptor() ([]byte, []int) {
	return file_videoapi_proto_rawDescGZIP(), []int{5}
}
...
func (x *Video) Reset() {
	*x = Video{}
	if protoimpl.UnsafeEnabled {
		mi := &file_videoapi_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Video) Descriptor() ([]byte, []int) {
	return file_videoapi_proto_rawDescGZIP(), []int{6}
}
...
func (x *User) Reset() {
	*x = User{}
	if protoimpl.UnsafeEnabled {
		mi := &file_videoapi_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*User) Descriptor() ([]byte, []int) {
	return file_videoapi_proto_rawDescGZIP(), []int{7}
}
...
var File_videoapi_proto protoreflect.FileDescriptor

var file_videoapi_proto_rawDesc = []byte{
	0x0a, 0x0e, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x61, 0x70, 0x69, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x12, 0x08, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x61, 0x70, 0x69, 0x1a, 0x09, 0x61, 0x70, 0x69, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x4c, 0x0a, 0x13, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f,
	...
	0x6b, 0x65, 0x6e, 0x22, 0xa3, 0x01, 0x0a, 0x14, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x66,
	0x65, 0x65, 0x64, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1f, 0x0a, 0x0b,
	...
	0x32, 0x0f, 0x2e, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x61, 0x70, 0x69, 0x2e, 0x56, 0x69, 0x64, 0x65,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x8e, 0x01, 0x0a, 0x1c, 0x64,
	...
	0x0f, 0x2e, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x61, 0x70, 0x69, 0x2e, 0x56, 0x69, 0x64, 0x65, 0x6f,
	0x52, 0x09, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x22, 0xfa, 0x01, 0x0a, 0x05,
	...
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x61, 0x70, 0x69,
	...
	0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0xe2, 0x02, 0x0a,
	0x0c, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x58, 0x0a,
	0x04, 0x46, 0x65, 0x65, 0x64, 0x12, 0x1d, 0x2e, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x61, 0x70, 0x69,
	0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x66, 0x65, 0x65, 0x64, 0x5f, 0x72, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x1e, 0x2e, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x61, 0x70, 0x69, 0x2e,
	...
	,
}

var (
	file_videoapi_proto_rawDescOnce sync.Once
	file_videoapi_proto_rawDescData = file_videoapi_proto_rawDesc
)

func file_videoapi_proto_rawDescGZIP() []byte {
	file_videoapi_proto_rawDescOnce.Do(func() {
		file_videoapi_proto_rawDescData = protoimpl.X.CompressGZIP(file_videoapi_proto_rawDescData)
	})
	return file_videoapi_proto_rawDescData
}

var file_videoapi_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_videoapi_proto_goTypes = []interface{}{
	(*DouyinFeedRequest)(nil),           // 0: videoapi.douyin_feed_request
	(*DouyinFeedResponse)(nil),          // 1: videoapi.douyin_feed_response
	(*DouyinPublishActionRequest)(nil),  // 2: videoapi.douyin_publish_action_request
	(*DouyinPublishActionResponse)(nil), // 3: videoapi.douyin_publish_action_response
	(*DouyinPublishListRequest)(nil),    // 4: videoapi.douyin_publish_list_request
	(*DouyinPublishListResponse)(nil),   // 5: videoapi.douyin_publish_list_response
	(*Video)(nil),                       // 6: videoapi.Video
	(*User)(nil),                        // 7: videoapi.User
}
var file_videoapi_proto_depIdxs = []int32{
	6, // 0: videoapi.douyin_feed_response.video_list:type_name -> videoapi.Video
	6, // 1: videoapi.douyin_publish_list_response.video_list:type_name -> videoapi.Video
	7, // 2: videoapi.Video.author:type_name -> videoapi.User
	0, // 3: videoapi.VideoService.Feed:input_type -> videoapi.douyin_feed_request
	2, // 4: videoapi.VideoService.PublishAction:input_type -> videoapi.douyin_publish_action_request
	4, // 5: videoapi.VideoService.PublishList:input_type -> videoapi.douyin_publish_list_request
	1, // 6: videoapi.VideoService.Feed:output_type -> videoapi.douyin_feed_response
	3, // 7: videoapi.VideoService.PublishAction:output_type -> videoapi.douyin_publish_action_response
	5, // 8: videoapi.VideoService.PublishList:output_type -> videoapi.douyin_publish_list_response
...
func init() { file_videoapi_proto_init() }
func file_videoapi_proto_init() {
	if File_videoapi_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_videoapi_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_videoapi_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_videoapi_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_videoapi_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_videoapi_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_videoapi_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_videoapi_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Video); i {
			case 0:
				return &v.state
			case 1:
		...
		file_videoapi_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_videoapi_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_videoapi_proto_goTypes,
		DependencyIndexes: file_videoapi_proto_depIdxs,
		MessageInfos:      file_videoapi_proto_msgTypes,
	}.Build()
	File_videoapi_proto = out.File
	file_videoapi_proto_rawDesc = nil
	file_videoapi_proto_goTypes = nil
	file_videoapi_proto_depIdxs = nil
}
