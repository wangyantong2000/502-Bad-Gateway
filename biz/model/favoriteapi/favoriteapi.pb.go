...
type DouyinFavoriteActionRequest struct {
	...
	VideoId    int64  `protobuf:"varint,3,opt,name=video_id,json=videoId,proto3" json:"video_id,omitempty" form:"video_id" query:"video_id"`                // 视频id
	ActionType int32  `protobuf:"varint,4,opt,name=action_type,json=actionType,proto3" json:"action_type,omitempty" form:"action_type" query:"action_type"` // 1-点赞，2-取消点赞
}

func (x *DouyinFavoriteActionRequest) Reset() {
	*x = DouyinFavoriteActionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_favoriteapi_proto_msgTypes[0]
...
func (*DouyinFavoriteActionRequest) Descriptor() ([]byte, []int) {
	return file_favoriteapi_proto_rawDescGZIP(), []int{0}
}
...
func (x *DouyinFavoriteActionResponse) Reset() {
	*x = DouyinFavoriteActionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_favoriteapi_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinFavoriteActionResponse) Descriptor() ([]byte, []int) {
	return file_favoriteapi_proto_rawDescGZIP(), []int{1}
}
...
func (x *DouyinFavoriteListRequest) Reset() {
	*x = DouyinFavoriteListRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_favoriteapi_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinFavoriteListRequest) Descriptor() ([]byte, []int) {
	return file_favoriteapi_proto_rawDescGZIP(), []int{2}
}
...
type DouyinFavoriteListResponse struct {
	...
	StatusCode int32    `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty" form:"status_code" query:"status_code"` // 状态码，0-成功，其他值-失败
	StatusMsg  string   `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" json:"status_msg,omitempty" form:"status_msg" query:"status_msg"`       // 返回状态描述
	VideoList  []*Video `protobuf:"bytes,3,rep,name=video_list,json=videoList,proto3" json:"video_list,omitempty" form:"video_list" query:"video_list"`       // 用户点赞视频列表
}

func (x *DouyinFavoriteListResponse) Reset() {
	*x = DouyinFavoriteListResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_favoriteapi_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinFavoriteListResponse) Descriptor() ([]byte, []int) {
	return file_favoriteapi_proto_rawDescGZIP(), []int{3}
}
...
func (x *Video) Reset() {
	*x = Video{}
	if protoimpl.UnsafeEnabled {
		mi := &file_favoriteapi_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Video) Descriptor() ([]byte, []int) {
	return file_favoriteapi_proto_rawDescGZIP(), []int{4}
}
...
func (x *User) Reset() {
	*x = User{}
	if protoimpl.UnsafeEnabled {
		mi := &file_favoriteapi_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*User) Descriptor() ([]byte, []int) {
	return file_favoriteapi_proto_rawDescGZIP(), []int{5}
}
...
var File_favoriteapi_proto protoreflect.FileDescriptor

var file_favoriteapi_proto_rawDesc = []byte{
	0x0a, 0x11, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x61, 0x70, 0x69, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x61, 0x70, 0x69,
	0x1a, 0x09, 0x61, 0x70, 0x69, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x72, 0x0a, 0x1e, 0x64,
	...
	0x73, 0x67, 0x22, 0x4d, 0x0a, 0x1c, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x66, 0x61, 0x76,
	...
	0x6e, 0x22, 0x92, 0x01, 0x0a, 0x1d, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x66, 0x61, 0x76,
	...
	0x4d, 0x73, 0x67, 0x12, 0x31, 0x0a, 0x0a, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x5f, 0x6c, 0x69, 0x73,
	0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69,
	0x74, 0x65, 0x61, 0x70, 0x69, 0x2e, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x52, 0x09, 0x76, 0x69, 0x64,
	0x65, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x22, 0xfd, 0x01, 0x0a, 0x05, 0x56, 0x69, 0x64, 0x65, 0x6f,
	0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64,
	0x12, 0x29, 0x0a, 0x06, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x11, 0x2e, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x61, 0x70, 0x69, 0x2e, 0x55,
	...
	0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x22, 0xe1, 0x02, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12,
	...
	,
	...
	0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x61, 0x70, 0x69, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e,
	0x5f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x5f, 0x72,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x23, 0xd2, 0xc1, 0x18, 0x1f, 0x2f, 0x64, 0x6f,
	0x75, 0x79, 0x69, 0x6e, 0x2f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x2f, 0x66, 0x61,
	0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x2f, 0x42, 0x1e, 0x5a, 0x1c,
	0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2f, 0x62, 0x69, 0x7a, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c,
	0x2f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x61, 0x70, 0x69, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_favoriteapi_proto_rawDescOnce sync.Once
	file_favoriteapi_proto_rawDescData = file_favoriteapi_proto_rawDesc
)

func file_favoriteapi_proto_rawDescGZIP() []byte {
	file_favoriteapi_proto_rawDescOnce.Do(func() {
		file_favoriteapi_proto_rawDescData = protoimpl.X.CompressGZIP(file_favoriteapi_proto_rawDescData)
	})
	return file_favoriteapi_proto_rawDescData
}

var file_favoriteapi_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_favoriteapi_proto_goTypes = []interface{}{
	(*DouyinFavoriteActionRequest)(nil),  // 0: favoriteapi.douyin_favorite_action_request
	(*DouyinFavoriteActionResponse)(nil), // 1: favoriteapi.douyin_favorite_action_response
	(*DouyinFavoriteListRequest)(nil),    // 2: favoriteapi.douyin_favorite_list_request
	(*DouyinFavoriteListResponse)(nil),   // 3: favoriteapi.douyin_favorite_list_response
	(*Video)(nil),                        // 4: favoriteapi.Video
	(*User)(nil),                         // 5: favoriteapi.User
}
var file_favoriteapi_proto_depIdxs = []int32{
	4, // 0: favoriteapi.douyin_favorite_list_response.video_list:type_name -> favoriteapi.Video
	5, // 1: favoriteapi.Video.author:type_name -> favoriteapi.User
	0, // 2: favoriteapi.FavoriteSrv.FavoriteAction:input_type -> favoriteapi.douyin_favorite_action_request
	2, // 3: favoriteapi.FavoriteSrv.FavoriteList:input_type -> favoriteapi.douyin_favorite_list_request
	1, // 4: favoriteapi.FavoriteSrv.FavoriteAction:output_type -> favoriteapi.douyin_favorite_action_response
	3, // 5: favoriteapi.FavoriteSrv.FavoriteList:output_type -> favoriteapi.douyin_favorite_list_response
...
func init() { file_favoriteapi_proto_init() }
func file_favoriteapi_proto_init() {
	if File_favoriteapi_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_favoriteapi_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_favoriteapi_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_favoriteapi_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_favoriteapi_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_favoriteapi_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Video); i {
			case 0:
				return &v.state
			case 1:
		...
		file_favoriteapi_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_favoriteapi_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_favoriteapi_proto_goTypes,
		DependencyIndexes: file_favoriteapi_proto_depIdxs,
		MessageInfos:      file_favoriteapi_proto_msgTypes,
	}.Build()
	File_favoriteapi_proto = out.File
	file_favoriteapi_proto_rawDesc = nil
	file_favoriteapi_proto_goTypes = nil
	file_favoriteapi_proto_depIdxs = nil
}
